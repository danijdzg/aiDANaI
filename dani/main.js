...
const renderPanelPage = async () => {
    ...
    // Definimos el espacio mínimo unificado: 5px
    const gap = '5px';
    ...
    // Relleno interno reducido (8px) y Margen inferior unificado (5px)
    const cardStyle = `padding: 8px 12px; margin-bottom: ${gap}; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.1);`;

    // Padding superior del contenedor = gap (5px) para igualar todo
    container.innerHTML = `
    <div style="padding: ${gap} 10px 10px 10px; height: 100%; display: flex; flex-direction: column; justify-content: flex-start;">
        ...
        <div class="hero-card fade-in-up" style="${cardStyle} background: rgba(255,255,255,0.03);">
            ...
            <div id="custom-date-filters" class="form-grid hidden" style="grid-template-columns: 1fr 1fr; gap: 5px; margin-bottom: 8px; background: rgba(0,0,0,0.2); padding: 5px; border-radius: 8px;">
                <div style="display:flex; flex-direction:column;">
