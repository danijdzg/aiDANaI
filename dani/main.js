    ...
    document.body.addEventListener('click', async (e) => {
        ...
        const actions = {
            ...
            'toggle-ledger': async () => {
                ...
                // Actualiza el botón visualmente (esto ya era correcto)
                ...
                // Identifica qué página está activa
                const activePageEl = selectOne('.view--active');
                const activePageId = activePageEl ? activePageEl.id : PAGE_IDS.INICIO;

                // ▼▼▼ ¡AQUÍ ESTÁ LA CORRECCIÓN CLAVE! ▼▼▼
                // Dependiendo de la página activa, llamamos a la función de refresco correcta.
                
                if (activePageId === PAGE_IDS.INICIO) {
                    // Para el Panel, la única forma correcta de actualizar es llamando a su "motor" principal.
                    await scheduleDashboardUpdate();
                } else {
                    // Para el resto de las páginas, sí es correcto volver a renderizarlas por completo.
                    const pageRenderers = {
