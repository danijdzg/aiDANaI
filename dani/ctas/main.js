...
const actions = {
    ...
    'show-help-topic': () => { /* Tu lógica existente de show-help-topic */ },
    ...
    'help': showHelpModal,
    'exit': handleExitApp,
    'forgot-password': (e) => { /* Tu lógica de forgot-password */ },
    'show-register': (e) => { /* Tu lógica de show-register */ },
    'show-login': (e) => { /* Tu lógica de show-login */ },
    'import-csv': showCsvImportWizard,
    'toggle-ledger': async () => { /* Tu lógica de toggle-ledger */ },
    'toggle-off-balance': async () => { /* Tu lógica de toggle-off-balance */ },
    'apply-filters': () => { hapticFeedback('light'); scheduleDashboardUpdate(); },
    'delete-movement-from-modal': () => { /* Tu lógica de delete-movement-from-modal */ },
    'swipe-delete-movement': () => { /* Tu lógica de swipe-delete-movement */ },
    'swipe-duplicate-movement': () => { /* Tu lógica de swipe-duplicate-movement */ },
    'search-result-movimiento': (e) => { hideModal('global-search-modal'); startMovementForm(e.target.closest('[data-id]').dataset.id, false); },
    'delete-concepto': async () => { /* Tu lógica de delete-concepto */ },
    'delete-cuenta': async () => { /* Tu lógica de delete-cuenta */ },
    ...
    'clear-data': () => { /* Tu lógica de clear-data */ },
    'update-budgets': handleUpdateBudgets, 'logout': () => fbAuth.signOut(), 'delete-account': () => { /* Tu lógica de delete-account */ },
    ...
    'duplicate-movement': () => { /* Tu lógica de duplicate-movement */ },
    ...
    'recalculate-balances': () => { /* Tu lógica de recalculate-balances */ },
    'json-wizard-back-2': () => goToJSONStep(1), 'json-wizard-import-final': () => handleFinalJsonImport(btn),
    'toggle-traspaso-accounts-filter': () => populateTraspasoDropdowns(), 'set-pin': async () => { /* Tu lógica de set-pin */ },
    ...
    // ▼▼▼ ACCIÓN NUEVA AÑADIDA CON LA COMA CORRECTA ▼▼▼
