...
const renderPanelPage = async () => {
    ...
    container.innerHTML = `
        <div style="padding: var(--sp-3) var(--sp-2) var(--sp-4);">
            ...
            <div class="fade-in-up" style="margin-bottom: var(--sp-3);">
                ...
                <div class="kpi-grid">
                    ...
                    <div class="kpi-item" data-action="show-kpi-drilldown" data-type="ingresos">
                        <h3 class="kpi-label">
                            INGRESOS <button class="help-btn" data-action="show-kpi-help" data-kpi="ingresos">?</button>
                        </h3>
                        <span id="kpi-ingresos-value" class="kpi-value text-positive skeleton" data-current-value="0">+0,00 €</span>
                    </div>

                    <div class="kpi-item" data-action="show-kpi-drilldown" data-type="gastos" style="border-top-color: var(--c-danger) !important; box-shadow: 0 -10px 25px rgba(255, 59, 48, 0.15) !important;">
                        <h3 class="kpi-label">
                            GASTOS <button class="help-btn" data-action="show-kpi-help" data-kpi="gastos">?</button>
                        </h3>
                        <span id="kpi-gastos-value" class="kpi-value text-negative skeleton" data-current-value="0">-0,00 €</span>
                    </div>

                    <div class="kpi-item" data-action="show-kpi-drilldown" data-type="saldoNeto" style="border-top-color: var(--c-info) !important; box-shadow: 0 -10px 25px rgba(41, 121, 255, 0.15) !important;">
                        <h3 class="kpi-label">
                            NETO <button class="help-btn" data-action="show-kpi-help" data-kpi="neto">?</button>
                        </h3>
                        <span id="kpi-saldo-neto-value" class="kpi-value skeleton" data-current-value="0">0,00 €</span>
                    </div>
                    ...
                    <div class="kpi-item">
                        ...
                        <span id="kpi-tasa-ahorro-value" class="kpi-value skeleton" data-current-value="0">0.00%</span>
                    </div>
                </div>
            </div>

            <div class="hero-card fade-in-up" onclick="goToPatrimonioChart()" style="cursor: pointer; padding: 25px 20px; text-align: center; margin-bottom: var(--sp-3); border: 1px solid #1a1a1a; background: #000000 !important; border-top: 4px solid var(--c-primary); box-shadow: 0 -10px 32px rgba(0, 179, 77, 0.15);">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <div id="kpi-patrimonio-neto-value" class="hero-value skeleton" data-current-value="0" style="font-size: 3rem; font-weight: 900; line-height: 1; color: #ffffff; text-shadow: 0 0 20px rgba(0, 179, 77, 0.4);">
                        0,00 €
                    </div>
                </div>

                <div style="background-color: #111111; border-radius: 16px; padding: 15px; display: grid; grid-template-columns: 1fr 1px 1fr; align-items: center; border: 1px solid #222;">
                    ...
                    <div style="text-align: center;">
                        ...
                        <div id="kpi-liquidez-value" class="text-positive skeleton" data-current-value="0" style="font-size: 1.1rem; font-weight: 700;">0,00 €</div>
                    </div>
                    ...
                    <div style="text-align: center;">
                        <div style="font-size: 0.65rem; font-weight: 700; color: #BF5AF2; text-transform: uppercase; margin-bottom: 4px; display:flex; justify-content:center; gap:4px; align-items:center;">
                            <span class="material-icons" style="font-size: 12px;">savings</span> 
                            Capital Inv. 
                            <button class="help-btn" data-action="show-kpi-help" data-kpi="capital_invertido">?</button>
                        </div>
                        <div id="kpi-capital-invertido-total" class="text-positive skeleton" data-current-value="0" style="font-size: 1.1rem; font-weight: 700;">0,00 €</div>
                    </div>
                </div>
            </div>
            ...
            <div class="hero-card fade-in-up" style="padding: 15px; margin-bottom: var(--sp-4); background: linear-gradient(180deg, var(--c-surface) 0%, rgba(0,0,0,0.2) 100%); border: 1px solid var(--c-outline);">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    ...
                    <div style="text-align: center;" data-widget-type="emergency-fund">
                        ...
                        <div id="emergency-fund-widget" style="display:none;"><div class="card__content skeleton"><span id="kpi-ef-months-value"></span><progress id="kpi-ef-progress"></progress><span id="kpi-ef-text"></span></div></div>
                        <div id="health-runway-val" class="skeleton" style="font-size: 1.3rem; font-weight: 800; color: #FFD60A;">0.0 Meses</div>
                    </div>

                    <div style="text-align: center; border-left: 1px solid var(--c-outline);" data-widget-type="fi-progress">
                        <div style="display: flex; justify-content: center; align-items: center; gap: 6px; margin-bottom: 6px;">
                        ...
                        <div id="fi-progress-widget" style="display:none;"><div class="card__content skeleton"><span id="kpi-fi-percentage-value"></span><progress id="kpi-fi-progress"></progress><span id="kpi-fi-text"></span></div></div>
