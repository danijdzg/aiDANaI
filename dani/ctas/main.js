...
const renderPanelPage = async () => {
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px;">
                <div style="text-align: center;">
                    <div style="${titleStyle}">
                        <span class="material-icons" style="font-size: 10px; vertical-align: middle;">shield</span> COBERTURA</div>
                ...
                <div style="text-align: center; border-left: 1px solid var(--c-outline);">
                    <div style="${titleStyle}">
                        <span class="material-icons" style="font-size: 10px; vertical-align: middle;">flag</span> LIBERTAD</div>
                    <div id="health-fi-val" class="skeleton" style="font-size: 1.2rem; font-weight: 800; color: #00B34D; white-space: nowrap;">0.0%</div>
                </div>
            </div>
        </div>
    ...
    setTimeout(() => {
        scheduleDashboardUpdate(); // Lanza los cálculos de números
    }, 50);
};
